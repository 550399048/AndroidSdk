...
public class SplashActivity extends Activity {
    ...
    private void getSplashAd() {
        ...
        skipContainer = findViewById(R.id.skip_view);
        // type:
        // 原生: 0
        // Banner: 1
        // 插屏: 2
        ...
        SplashAd.SplashAdListener listener = new SplashAd.SplashAdListener() {
            ...
            public void onADDismissed() {
                ...
                skipContainer.setText(String.format(SKIP_TEXT, Math.round(0 / 1000f)));
                jumpWhenCanClick();
            }
            ...
            public void onADTick(long l) {
                skipContainer.setText(String.format(SKIP_TEXT, Math.round(l / 1000f)));
            }
        };

        SplashAd ad = new SplashAd(getApplicationContext(), container, skipContainer, Constants.APP_ID, Constants.SPLASH_POS_ID, listener,0);
        ad.loadAd();
    }
