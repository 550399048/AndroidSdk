...
public class NativeVerticalActivity extends Activity implements View.OnClickListener{
    private static final String TAG = "NativeVerticalActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ((EditText) findViewById(R.id.posId)).setText(Constants.NATIVE_VERTICAL_POS_ID);
        nativeView = getLayoutInflater().inflate(R.layout.native_ad_vertical_layout,null);
    ...
    private NativeAd getNativeAd(){
        ...
        if (nativeAd == null) {
            NativeAd.NativeAdListener listener = new NativeAd.NativeAdListener() {
                ...
                public void onADLoaded(final List<NativeAdData> adData) {
                    ...
                    for (int i = 0; i < adData.size(); i++) {
                        ...
                        Glide.with(NativeVerticalActivity.this.getApplicationContext())
                                .load(imageUrl)
            ...
            nativeAd = new NativeAd(getApplicationContext(), Constants.APP_ID, Constants.NATIVE_VERTICAL_POS_ID,6, listener);
        }
        return nativeAd;
    }
    ...
    private String getPosID() {
        ...
        return TextUtils.isEmpty(posId) ? Constants.NATIVE_VERTICAL_POS_ID : posId;
    }
