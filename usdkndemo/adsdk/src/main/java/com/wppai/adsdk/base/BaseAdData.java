...
public class BaseAdData {
    ...
    public void onClicked(int down_x, int down_y, int up_x, int up_y) {
        ...
        clickToServer(down_x, down_y, up_x, up_y);
        clickCCToServer(down_x, down_y, up_x, up_y);
    }

    private void clickToServer(int down_x, int down_y, int up_x, int up_y) {
        if (click_link == null || pos_width == null || pos_height == null || req_width == null || req_height == null) {
            return;
        }
    ...
    private void clickCCToServer(int down_x, int down_y, int up_x, int up_y) {
        if (click_link_cc == null || pos_width == null || pos_height == null || req_width == null || req_height == null) {
            return;
        }
        // cc to server
        OkHttpClient client = new OkHttpClient();
    ...
    private void handleDstLink(final String dstLink) {
        ...
        guessFileName = guessFileNameFromUrl(dstLink);

        if (!TextUtils.isEmpty(fsnameStr)) {
            fileName = fsnameStr;
        ...
        Log.i(TAG, "fsname:" + pkgName + ",img2_url=" + img2_url + ",guessFildeName = " + fileName);
